...
public class ODDCclass implements ODDCinterface {
    ...
    public boolean ok2Startup(){
        ...
        jobList = controller.getJobList(); // FIXME parse jobList and perform tasks
    ...
    public ArrayList<LogData> getLog(DataPackageType t){
        ...
        switch(t){
            case CONTINUOUS:
                selectSTR = "select sessionID,GShockEvent,FCWEvent,LDWEvent,GPStimeStamp,MediaURI,MediaDeleted,MediaUploaded,DataUploaded from oddc where GShockEvent = 0 and FCWEvent = 0 and LDWEvent = 0";
                break;
            case EVENT:
    ...
    private static final String SQL_CREATE_TABLE =
            "CREATE TABLE IF NOT EXISTS " + DBschema.TABLE_NAME + " (" +
                    ...
                    DBschema.ID       + " CHAR(16)," +
                    DBschema.SID      + " CHAR(16)," +
                    DBschema.VIN      + " CHAR(18)," +
                    DBschema.DID      + " CHAR(50)," +
                    DBschema.MID      + " CHAR(16)," +
                    DBschema.TZ       + " INT," +
        ...
        public void run(){
            ...
            if (nrows > 0)
            {
                ...
                while (c.moveToNext()){
                    ...
                    cd.ldwTimeStamp = Timestamp.valueOf(c.getString(24));
